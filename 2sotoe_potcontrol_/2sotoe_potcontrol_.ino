...
// include libraries and craete objects
#include <Servo.h>
...
void loop() {
  // calculate the pot analog signal to a writeable servo pwm signal
...
// the main math for 2sotoe
 servo0.write(angle);
 int othAngle = 180 -  angle;
 servo1.write(othAngle);

delay(15); // give the servo time to get to the correct position
}
